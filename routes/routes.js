...
router.get(`/`, controller.isLoggedIn, controller.getHomePage); //if logged in: can go here, otherwise goes back to login page 
...
router.get(`/home`, controller.isLoggedIn, controller.getHomePage); 
